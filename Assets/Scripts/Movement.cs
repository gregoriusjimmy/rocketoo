...
public class Movement : MonoBehaviour
{
   ...
   [SerializeField] float mainThurst = 200;
   ...
   float minMainThrust = 400;
   float maxMainThrust = 1000;
   ...
   {
      if (Input.GetAxis("Horizontal") < 0) RotateLeft();
      else if (Input.GetAxis("Horizontal") > 0) RotateRight();
      // else StopRotating();
   }
